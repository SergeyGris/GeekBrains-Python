...
-- скопировал базу данных shop и дополнил данным в таблице orders 
...
ON cities_from.label=flights.`from`
JOIN cities AS cities_to
ON cities_to.label=flights.`to` 


-- И получилось еще вложенным запросом
USE lesson7;
SELECT id, 
